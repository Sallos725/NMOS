...
> current** (approved 2026-09-24). Phases 0–3, the Phase 4 soft subset, Phase 5 (`v0.1.0-beta.12`) and
> Phase 6 (`v0.1.0-beta.13`) are complete. Public beta. Hard POV isolation (D9 `character_pov`), the
> rest of B3 and Track B, B4–B7 are not authorized. Bug fixes, correctness, docs and CI work stay
> allowed.
...
| 7 — promise threads and event salience (Track B, B3) | **current** (approved 2026-09-24) | `PHASE-7.md` |
