...
| Known issues | `docs/KNOWN-ISSUES.md` | K1–K27 (K10 resolved) current as of `v0.1.0-beta.21`, each with workaround and tracking (host, Track B stage); resolved limitations listed |
