...
| Tests | `apps/sidecar/tests` (335), `adapters/pocketrisu-plugin/test` (91) | all passing; deterministic memory evaluation `docs/perf/eval-baseline.md` (with budget pressure since Phase 9) |
...
| Known issues | `docs/KNOWN-ISSUES.md` | K1–K27 (K10 resolved) current as of `v0.1.0-beta.19`, each with workaround and tracking (host, Track B stage); resolved limitations listed |
...
| Audits | `docs/audits/NMOS-AUDIT-2026-09-26.md` + `-REVIEW.md` | A-02, A-04 fixed (unreleased); A-01 is K27 (owner decision); the rest open, ordered in the review |
