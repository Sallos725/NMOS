...
(Q1–Q5). Steps 1–2 done (one whereabouts per item, ADR 0016; `destroyed` and
`extract-v6`, ADR 0017; D30). Step 3 (conflicts, `disputed="true"`) is next.
...
| Tests | `apps/sidecar/tests` (217), `adapters/pocketrisu-plugin/test` (46) | all passing; deterministic memory evaluation `docs/perf/eval-baseline.md` |
