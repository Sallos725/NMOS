...
| Tests | `apps/sidecar/tests` (347), `adapters/pocketrisu-plugin/test` (91) | all passing; deterministic memory evaluation `docs/perf/eval-baseline.md` (with budget pressure since Phase 9) |
...
| Audits | `docs/audits/NMOS-AUDIT-2026-09-26.md` + `-REVIEW.md` | A-01 (ADR 0029, D40), A-02, A-04 fixed in `v0.1.0-beta.20`; A-03, A-07, A-08, A-16 fixed (unreleased); the rest open, ordered in the review |
