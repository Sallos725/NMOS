...
| A-09 follow-up, deadline at ≈10,000 messages | A: keep the 3 s default, and warn in the plugin UI when requests run close to or over the deadline, suggesting a higher value | done: Status-tab card, one alert per page after a reply (H18), progress-display text; D24 amended |
